...
public class gallery_view_2 extends AppCompatActivity {
    ...
    private final String panelUrl = "https://www.gunbatarshapagy.com/Site15/mobile2.html";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.gallery_tm);
