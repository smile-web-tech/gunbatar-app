...
public class gallery1_view extends AppCompatActivity {
    ...
    private final String panelUrl = "https://www.gunbatarshapagy.com/Site15/mobile1.html";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.title_gallery_1);
