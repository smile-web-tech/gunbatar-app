...
public class panel_view extends AppCompatActivity {
    ...
    private final String panelUrl = "https://gunbatarshapagy.com/admin";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.title_panel_tm);
